...
# Version 2021-06-21_V11 Loxberry Plugin - Ondilo ICO Poolsensor
...
# ---------------------------------------------------------------------------------------
    if os.path.isfile('/opt/loxberry/config/plugins/ICO/tokens.txt'):
        with open('/opt/loxberry/config/plugins//ICO/tokens.txt', "r") as f:
...
### (no refresh_token or refresh_token expired) - Add refresh_token to tokens.txt file ###
# ---------------------------------------------------------------------------------------
    if access_token == "Error":
        ...
        f = open('/opt/loxberry/config/plugins/ICO/tokens.txt', "a")
        f.write("\n")
...
# ---------------------------------------------------------------------------------------
    ...
    # ---------------------------------------------------------------------------------------
        ...
        print('(Refresh Token added to tokens.txt)')
        print('--------------------------------------------------------')
        print('\n')
