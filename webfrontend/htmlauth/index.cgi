...
# ---------------------------------------
if (param('savedata')) {
	$conf = new Config::Simple("$home/config/plugins/$psubfolder/ico.cfg");
	...
	$conf->param('ICO.USERNAME', unquotemeta($username));
	$conf->param('ICO.PASSWORD', unquotemeta($password));
	$conf->param('ICO.MINISERVER', unquotemeta("MINISERVER$miniserver"));
	$conf->param('ICO.UDPPORT', unquotemeta($msudpport));
	$conf->param('ICO.ENABLED', unquotemeta($enabled));
	$conf->param('ICO.LOCALTIME', unquotemeta($localtime));
...
# ---------------------------------------
$conf = new Config::Simple("$home/config/plugins/$psubfolder/ico.cfg");
$username = encode_entities($conf->param('ICO.USERNAME'));
$password = encode_entities($conf->param('ICO.PASSWORD'));
$miniserver = encode_entities($conf->param('ICO.MINISERVER'));
$msudpport = encode_entities($conf->param('ICO.UDPPORT'));
$enabled = encode_entities($conf->param('ICO.ENABLED'));
$localtime = encode_entities($conf->param('ICO.LOCALTIME'));
...
# Title
$template_title = $phrase->param("TXT0000") . ": ICO";
