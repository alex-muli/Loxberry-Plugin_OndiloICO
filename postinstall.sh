...
/bin/sed -i "s#REPLACEBYBASEFOLDER#$ARGV5#g" $LBPDATA/$ARGV3/ico.py
...
/bin/sed -i "s#REPLACEBYSUBFOLDER#$ARGV3#g" $LBPDATA/$ARGV3/ico.py
...
/bin/sed -i "s#REPLACEBYPLUGINNAME#$ARGV2#g" $LBPDATA/$ARGV3/ico.py
